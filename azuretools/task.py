...
from azuretools.auth import get_compute_node_identity_reference
from azuretools.defaults import default_azure_blob_storage_endpoint_subdomain
from azuretools.endpoint import construct_blob_container_endpoint
